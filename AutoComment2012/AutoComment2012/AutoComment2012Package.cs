...
namespace HKFY.AutoComment2012
{
    ...
    [Guid(GuidList.guidAutoComment2012PkgString)]
    public sealed class AutoComment2012Package : Package
    {
        ...
        protected override void Initialize()
        {
            ...
            if ( null != mcs )
            {
                ...
                CommandID menuCommandID = new CommandID(GuidList.guidAutoComment2012CmdSet, (int)PkgCmdIDList.ChangeDetail);
                MenuCommand menuItem = new MenuCommand(ChangeDetailCallBack, menuCommandID);
                mcs.AddCommand( menuItem );

                menuCommandID = new CommandID(GuidList.guidAutoComment2012CmdSet, (int)PkgCmdIDList.CppChangeHistory);
                menuItem = new MenuCommand(CppChangeHistoryCallBack, menuCommandID);
                mcs.AddCommand(menuItem);

                menuCommandID = new CommandID(GuidList.guidAutoComment2012CmdSet, (int)PkgCmdIDList.DocClass);
                menuItem = new MenuCommand(DocClassCallBack, menuCommandID);
                mcs.AddCommand(menuItem);

                menuCommandID = new CommandID(GuidList.guidAutoComment2012CmdSet, (int)PkgCmdIDList.DocFunction);
                menuItem = new MenuCommand(DocFunctionCallBack, menuCommandID);
                mcs.AddCommand(menuItem);

                menuCommandID = new CommandID(GuidList.guidAutoComment2012CmdSet, (int)PkgCmdIDList.DocMember);
                menuItem = new MenuCommand(DocMemberCallBack, menuCommandID);
                mcs.AddCommand(menuItem);

                menuCommandID = new CommandID(GuidList.guidAutoComment2012CmdSet, (int)PkgCmdIDList.DocGenList);
                menuItem = new MenuCommand(DocGenListCallBack, menuCommandID);
                mcs.AddCommand(menuItem);

                menuCommandID = new CommandID(GuidList.guidAutoComment2012CmdSet, (int)PkgCmdIDList.DocGenTable);
                menuItem = new MenuCommand(DocGenTableCallBack, menuCommandID);
                mcs.AddCommand(menuItem);

                menuCommandID = new CommandID(GuidList.guidAutoComment2012CmdSet, (int)PkgCmdIDList.DoNetChangeHistory);
                menuItem = new MenuCommand(DoNetChangeHistoryCallBack, menuCommandID);
                mcs.AddCommand(menuItem);

                menuCommandID = new CommandID(GuidList.guidAutoComment2012CmdSet, (int)PkgCmdIDList.DoNetFunction);
